...
You will always use the same language the user speaks.

The following are behavioral guidelines to reduce common LLM coding mistakes. Merge with project-specific instructions as needed.
